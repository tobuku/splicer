...
export default async function ListingPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const isFeatured = slug === 'all-american-fiber-solutions-llc-kingsville-mo'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Header */}
              <div className={`rounded-2xl p-6 ${isFeatured ? 'bg-gradient-to-br from-amber-50 to-white border-2 border-amber-400 shadow-lg shadow-amber-100/50 relative overflow-hidden' : 'bg-white border border-[#e8e8e8]'}`}>
                {isFeatured && (
                  <div className="absolute top-0 right-0">
                    <div className="bg-gradient-to-r from-amber-500 to-amber-600 text-white text-xs font-bold px-4 py-1.5 rounded-bl-xl shadow-md flex items-center gap-1.5">
            ...
            <div className="space-y-5">
              {/* Contact info */}
              <div className={`rounded-2xl p-5 ${isFeatured ? 'bg-gradient-to-br from-amber-50 to-white border-2 border-amber-400 shadow-md shadow-amber-100/50' : 'bg-white border border-[#e8e8e8]'}`}>
